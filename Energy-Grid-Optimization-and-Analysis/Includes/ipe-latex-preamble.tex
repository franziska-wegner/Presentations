%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% @file   ipe-latex-preamble.tex
% @author Franziska Wegner
% @date   June 16, 2020
%
% @description  This file unifies all requirments for the IPE pre-
%     sentations w.r.t. LaTeX. It includes important packages, files,
%     and defines general environments and commands.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% Algorithm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[titlenumbered, ruled, vlined, linesnumbered,resetcount]{algorithm2e}
